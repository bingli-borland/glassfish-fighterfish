...
/**
 * A simple bundle that can download Astra zip from a URL specified using {@link Astra_ARCHIVE_URL}
 * into a location specified in {@link INSTALLATION_DIR} property. It then bootstraps Astra in the same
 * JVM.
 *
...
public class Activator implements BundleActivator {
    ...
    private final String Astra_ARCHIVE_URL = "fighterfish.provisioner.url";
    ...
    private void startAstraBundle(BundleContext context) throws BundleException {
    ...
    private void explode(BundleContext context) throws Exception {
        String in = context.getProperty(Astra_ARCHIVE_URL);
        ...
        if (in != null) {
            ...
            throw new Exception("Pl specify Astra archive URL in a property called " + Astra_ARCHIVE_URL);
        }
    }
